...
public class PlayerSprite extends B2DSprite{
	...
	private void configureFrames(){
		walktex = Game.res.getTexture("player-walk");
		idletex = Game.res.getTexture("player-idle");
		jumptex = Game.res.getTexture("player-jump");
		falltex = Game.res.getTexture("player-fall");
