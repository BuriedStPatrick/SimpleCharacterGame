package com.patrickchristensen.simplecharacter.gamecameras;

import com.badlogic.gdx.graphics.OrthographicCamera;

public class GameCameraBounded extends OrthographicCamera {

    private float xmin, xmax, ymin, ymax;

    public GameCameraBounded() {
        this(0, 0, 0, 0);
    }

    public GameCameraBounded(float xmin, float xmax, float ymin, float ymax){
        super();
